...
export const useSwipeAlgorithm = (usersAllData, userData) => {
    ...
    useEffect(() => {
        ...
        const profiles = usersAllData.map(obj => ({
            user_id: obj.user_id,
        ...
        const user = {
            ...
            user_kindOfGamer: userData.user_kindOfGamer,
            user_game: userData.user_game,
            lol_server: userData.lol_server,
            lol_main1: userData.lol_main1,
            lol_main2: userData.lol_main2,
            lol_main3: userData.lol_main3,
            lol_rank: userData.lol_rank,
            lol_role: userData.lol_role,
            usersServerValorant: userData.usersServerValorant,
            usersMainValorant1: userData.usersMainValorant1,
            usersMainValorant2: userData.usersMainValorant2,
            usersMainValorant3: userData.usersMainValorant3,
            usersRankValorant: userData.usersRankValorant,
            usersRoleValorant: userData.usersRoleValorant,
            lf_gender: userData.lf_gender,
            lf_kindofgamer: userData.lf_kindofgamer,
            lf_game: userData.lf_game,
            lf_lolmain1: userData.lf_lolmain1,
            lf_lolmain2: userData.lf_lolmain2,
            lf_lolmain3: userData.lf_lolmain3,
            lf_lolrank: userData.lf_lolrank,
            lf_lolrole: userData.lf_lolrole,
            usersMainValorant1Lf: userData.usersMainValorant1Lf,
            usersMainValorant2Lf: userData.usersMainValorant2Lf,
            usersMainValorant3Lf: userData.usersMainValorant3Lf,
            usersRankValorantLf: userData.usersRankValorantLf,
            usersRoleValorantLf: userData.usersRoleValorantLf
          };
